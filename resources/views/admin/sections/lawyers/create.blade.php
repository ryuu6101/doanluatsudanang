                    ...
                    <div class="row">
                        <div class="col-4 text-center px-5">
                            ...
                            <a href="javascript:open_filemanager('profile_pic')">
                                @php($img_url = old('profile_pic') ?? asset('doanluatsudanang/themes/default/images/no-avatar.jpg'))
                                <img src="{{ $img_url }}" alt="" class="img-fluid w-100 rounded border border profile-pic-preview">
                            </a>
                        </div>
                        <div class="col-1"></div>
                        <div class="col-6">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            name="birthday"readonly value="{{ old('birthday') ?? today()->format('d/m/Y') }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Ngày cấp thẻ</th>
                                        <td>
                                            ...
                                            readonly value="{{ old('card_issuance_date') ?? today()->format('d/m/Y') }}">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
